...
## Run Information
- Mayhem Run: mayhemheroes/sdl-sound/sdl-sound-fuzzer/9
- Git Commit: f245e080f0305b35ab9b3dae19e355347a9d08d3
- Original Image: ghcr.io/mayhemheroes/sdl_sound:main
- Target Executable: /SDL_sound-fuzzer
- CI URL: https://github.com:443/mayhemheroes/SDL_sound/actions/runs/3186716701
...
- Source code: `/rlenv/source/sdl-sound/`
...
Look at `Dockerfile` and identify:
...
RUN cp <build-artifact> /SDL_sound-fuzzer

# 11. Permission Management (REQUIRED)
RUN chmod 766 /SDL_sound-fuzzer
...
- `COPY . /rlenv/source/sdl-sound/` happens early (source exists)
...
- ✅ Must work from `/rlenv/source/sdl-sound/`

## Critical Requirements Checklist

### Permissions (REQUIRED)
- [ ] Source directory: `chmod -R 777 /rlenv/source`
- [ ] Target executable: `chmod 766 /SDL_sound-fuzzer`
...
- [ ] Target executable in Dockerfile.rlenv: `/SDL_sound-fuzzer`
- [ ] Target executable in build.sh: `/SDL_sound-fuzzer`
- [ ] Target executable in metadata.json: `/SDL_sound-fuzzer`
- [ ] All must match for validation to work

### COPY Order (REQUIRED)
- [ ] `COPY . /rlenv/source/sdl-sound/` - EARLY (source exists now)
...
WORKDIR /rlenv/source/sdl-sound/fuzz
...
- Source copy: `COPY . /rlenv/source/sdl-sound/`
...
- Working directory: `cd /rlenv/source/sdl-sound/`
- No network access
